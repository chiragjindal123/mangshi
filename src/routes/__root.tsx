  ...
  head: () => ({
    meta: [
      ...
      { title: "Mangshi 盲食 — 就吃盲食!" },
      {
        name: "description",
        content:
          "Mangshi 盲食 — Homecook meals from rescued surplus produce. What will we eat today?",
      },
      ...
      { property: "og:site_name", content: "Mangshi 盲食" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "Mangshi 盲食" },
      {
    ...
    links: [
      ...
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=Lora:ital,wght@0,400;0,500;0,600;0,700;1,400;1,500;1,600&family=Inter:wght@300;400;500;600&family=JetBrains+Mono:wght@400;500&family=Noto+Serif+TC:wght@500;600;700&display=swap",
      },
    ],
  }),
...
function RootShell({ children }: { children: React.ReactNode }) {
  return <LanguageProvider><Document>{children}</Document></LanguageProvider>;
}
